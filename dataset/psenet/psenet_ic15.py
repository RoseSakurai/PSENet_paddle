...
#
# custom_dataset = PSENET_IC15(is_transform=True)
#
#
...
#     # # data := [img, gt_text, gt_kernels, training_mask]
#     # print(type(data[0]), data[0].shape)
#     # print(type(data[1]), data[1].shape)
#     # print(type(data[2]), data[2].shape)
#     # print(type(data[3]), data[3].shape)
#     print('success')
#
#     if iter > 1:
#         break
